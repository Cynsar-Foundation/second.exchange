          ...
          >
            <Stack flex={1} spacing={{ base: 5, md: 10 }}>
              ...
              <Text fontSize="md" color={"gray.500"}>
                <p>
                  Second exchange is a censor resitant social media that lets
                  anyone create content.
                </p>
        ...
        <SimpleGrid columns={{ base: 1, md: 2 }} spacing={10}>
          <Stack spacing={4}>
            ...
            <Text color={"gray.500"} fontSize={"lg"}>
              We use basic cryptography (not crypto coins) to sign your content
              , just think like your signing a paper but its all digital and
              using those signatures to share content.
            </Text>
            <Stack
              spacing={4}
      ...
      <Container maxW={"5xl"} py={12}>
        <SimpleGrid columns={{ base: 1, md: 2 }} spacing={10}>
          ...
          <Stack spacing={4}>
            ...
            <Text color={"gray.500"} fontSize={"lg"}>
              We use nostr relays to share your content, when you create content
              the signed data is sent to a dumb relay that shares it across the
              internet to other relays, so your content is protected from
              censorship.
            </Text>
            <Stack
              spacing={4}
              divider={<StackDivider borderColor={borderOne} />}
            >
              <Feature
                icon={
                  <Icon
